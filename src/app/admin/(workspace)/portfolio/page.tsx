...
export default function AdminPortfolioPage() {
  ...
  async function saveProject() {
    ...
    if (!editing.title?.trim()) errors.title = "Project title is required.";
    if (editing.image && !editing.imageAlt?.trim()) {
      errors.imageAlt = "Add alt text for the cover image.";
    }
    if (editing.heroImage && !editing.heroImageAlt?.trim()) {
      errors.heroImageAlt = "Add alt text for the hero image.";
    }
  ...
  async function remove(item: PortfolioItemDTO) {
    if (!confirmNamedDestructive("portfolio project", item.title)) return;
    const res = await adminFetch(`/api/admin/portfolio/${item.id}`, { method: "DELETE" });
            ...
            <div className="mb-10 border border-stone/30 p-4 sm:p-6">
              ...
              <div className="grid gap-6 md:grid-cols-2">
                ...
                <div className="md:col-span-2">
                  ...
                  />
                  <div className="mt-4">
                    <AdminField label="Cover Image Alt Text" error={validationErrors.imageAlt}>
                      <AdminInput
                ...
                <div className="md:col-span-2">
                  ...
                  />
                  <div className="mt-4">
                    <AdminField label="Hero Image Alt Text" error={validationErrors.heroImageAlt}>
                      <AdminInput
                        value={editing.heroImageAlt || ""}
                        onChange={(e) => setEditing({ ...editing, heroImageAlt: e.target.value })}
                      />
                    </AdminField>
                  </div>
                </div>
