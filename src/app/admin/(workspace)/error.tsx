      ...
      <div className="w-full max-w-md rounded-2xl border border-stone/25 bg-charcoal/30 p-8 text-center">
        ...
        <div className="mt-6 flex justify-center gap-3">
          <button
            type="button"
            onClick={reset}
            className="min-h-11 rounded-lg border border-accent/40 bg-accent/10 px-4 py-2 text-xs tracking-[0.1em] text-accent uppercase transition-colors hover:bg-accent/20"
          >
            Retry
          </button>
          <a
            href="/admin"
            className="inline-flex min-h-11 items-center rounded-lg border border-stone/30 px-4 py-2 text-xs tracking-[0.1em] text-fog uppercase transition-colors hover:border-stone/50 hover:text-cream"
          >
            Command Center
          </a>
        </div>
