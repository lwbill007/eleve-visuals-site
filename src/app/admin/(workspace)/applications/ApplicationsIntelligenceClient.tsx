...
export default function ApplicationsIntelligenceClient() {
  ...
  const rerank = useCallback(async () => {
    ...
    try {
      ...
      toast(
        timedOut
          ? "AI evaluation is taking longer than two minutes. Previous rankings were preserved; refresh shortly to check for completed results."
          : "AI re-rank could not be completed. Previous rankings were preserved.",
        "error"
      );
    } finally {
      setRefreshing(false);
